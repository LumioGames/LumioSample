...
public sealed class SampleTablesTests
{
    ...
    {
        string source = File.ReadAllText(Path.Combine(RepoRoot, "Gameplay", "Config", "SampleTables.cs"));
    ...
    public void HandwrittenSourceDoesNotEmbedConfigNumbers()
    {
        ...
        string gameplay = Path.Combine(RepoRoot, "Gameplay");
    ...
    private static string ConfigPath(string stem) => Path.Combine(RepoRoot, "Server", "Config", "Tables", "server", stem + ".json");
