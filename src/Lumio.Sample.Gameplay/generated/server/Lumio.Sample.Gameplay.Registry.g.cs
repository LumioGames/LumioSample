...
public sealed class GeneratedRegistry : EcsRegistry
{
    ...
    public override int ComponentIndex(Type entityType, Type componentType)
    {
        ...
        if (entityType == typeof(PlayerEntity))
        {
            ...
            if (componentType == typeof(AbilityComponent)) return 3;
            if (componentType == typeof(AttributeComponent)) return 4;
            if (componentType == typeof(EffectComponent)) return 5;
            return -1;
        }
        if (entityType == typeof(VeinEntity))
        {
    ...
    public override int ComponentIndex(Type entityType, string componentName)
    {
        ...
        if (entityType == typeof(PlayerEntity))
        {
            ...
            if (string.Equals(componentName, "AbilityComponent", StringComparison.Ordinal)) return 3;
            if (string.Equals(componentName, "AttributeComponent", StringComparison.Ordinal)) return 4;
            if (string.Equals(componentName, "EffectComponent", StringComparison.Ordinal)) return 5;
            return -1;
        }
        if (entityType == typeof(VeinEntity))
        {
